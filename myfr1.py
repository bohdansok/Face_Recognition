...
def get_params(fl_dir_comment=True, lang="ukr"):
    ...
    dir_comment = ""
    #
    answ = simpledialog.askfloat(myfrlang.lang[lang]["get_params"][10],
    ...
    if answ not in [None, ""]:  # setting cobfidence for facecomp
        ...
        return
    njits = simpledialog.askinteger(myfrlang.lang[lang]["get_params"][4],
    ...
    if fl_dir_comment:
        dir_comment = simpledialog.askstring(
...
def optim(lang="ukr"):
    ...
    if len(fd.fd["encodings"]) > 0:
        ...
        fd.save_as(fn)
    fd.destroy()
    messagebox.showinfo(myfrlang.lang[lang]["optim"][10],
...
def splitvid(root, lang="ukr"):
    ...
    fl_MultyTh = False
    frfl = face_recognition.face_locations
    vidfile = filedialog.askopenfilename(master=root, title=myfrlang.lang[lang]["splitvid"][0],
    ...
    while True:
        ...
        if len(boxes) > 0:
            ...
            if not wrtn:
                messagebox.showinfo(myfrlang.lang[lang]["splitvid"][2],
    ...
    if fl_MultyTh:
        executor.shutdown(wait=False)
    messagebox.showinfo(myfrlang.lang[lang]["splitvid"][4],
...
def showcurwdir(lang="ukr"):
    ...
    try:
        ...
        messagebox.showwarning(myfrlang.lang[lang]["showcurwdir"][0],
        myfrlang.lang[lang]["showcurwdir"][1])
    else:
        messagebox.showinfo(myfrlang.lang[lang]["showcurwdir"][2],

...
-	код став більш структурований (деякі функції перенесено в окремий модулт MYFR1.PYб так само як частина залежних від мови діалогів - до мдулю MYFRLANG.P), введено новий клас Face_Dictionary;
